...
<script type="text/javascript" src="interface/makemoney.js"></script>
<script type="text/javascript" src="interface/indexpage.js"></script>
<script type="text/javascript" src="interface/cinema.js"></script>
<script type="text/javascript" src="interface/mall.js"></script>
<script type="text/javascript" src="interface/gift.js"></script>
<script type="text/javascript" src="interface/usercenter.js"></script>
<script type="text/javascript" src="interface/help.js"></script>
<script type="text/javascript" src="interface/cache.js"></script>
<style type="text/css">
	.input-div{
		width:100%;
		height: 30px;
...
// 	    getDivText();
	...
	function testRestful(){
		$.ajax({
			  url: "http://192.168.10.112:8880/services",
			  async:false,
			  dataType:"json",
