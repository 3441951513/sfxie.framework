...
(
	...
	-- 动作资源
	action_url varchar(100) COMMENT '动作资源',
	-- 排序字段
	...
	param_flag varchar(100) COMMENT '置参数标记',
	-- 菜单代码
	menu_code varchar(32) COMMENT '菜单代码',
	PRIMARY KEY (id_)
...
(
	...
	-- 记录创建人
	create_user varchar(32) COMMENT '记录创建人',
	-- 分区字段,从用户公司代码字段取值
...
(
	...
	id_ varchar(64) NOT NULL COMMENT '记录主键',
	-- 角色代码
	role_id varchar(32) COMMENT '角色主键',
	-- 资源名称
	...
	is_valid char COMMENT '是否有效',
	-- 上上一级公司，也就是这一级的上一级公司
	owner_company_code varchar(64) COMMENT '上一级公司',
	sql_ varchar(2000) COMMENT '数据权限sql查询语句',
	-- 关联角色菜单关联表id
	role_menu_id varchar(32) COMMENT '角色菜单关联表id',
	-- 用java处理类获取sql或者用户列表
	dealer_class varchar(200) COMMENT 'java处理类',
	-- 创建公司
	create_company_id varchar(50) COMMENT '创建公司',
	-- 分区字段,从用户公司代码字段取值
	partition_company varchar(8) NOT NULL COMMENT '分区字段',
	PRIMARY KEY (id_)
) ENGINE = InnoDB COMMENT = '数据权限表' DEFAULT CHARACTER SET utf8;
...
(
	...
	is_valid char COMMENT '是否有效',
	-- 关联角色菜单关联表id
	role_menu_id varchar(64) COMMENT '角色菜单关联表id',
	-- 关联数据权限表id
	auth_data_id varchar(64) COMMENT '数据权限表id',
	-- 上上一级公司，也就是这一级的上一级公司
	owner_company_code varchar(64) COMMENT '上一级公司',
	-- 公司角色关联表id
	company_role_id varchar(32) COMMENT '公司角色关联表id',
	-- 分区字段,从用户公司代码字段取值
	partition_company varchar(8) NOT NULL COMMENT '分区字段',
	PRIMARY KEY (id_)
...
(
	...
	id_ varchar(64) NOT NULL COMMENT '记录主键',
	-- 菜单代码
	menu_code varchar(32) NOT NULL UNIQUE COMMENT '菜单代码',
	-- 关联web_system表
	system_id varchar(64) COMMENT '关联system_id',
	-- 关联数据权限主键
	auth_data_id varchar(32) COMMENT '数据权限id',
	-- 菜单名称
	menu_name varchar(50) COMMENT '菜单名称',
	-- 资源
	url varchar(100) COMMENT '资源',
	-- 描述
	description varchar(200) COMMENT '描述',
	-- 繁体菜单名称
	menu_name_tw varchar(50) COMMENT '繁体菜单名称',
	-- 网站标识 smis ems sms
	webside varchar(10) COMMENT '网站标识',
	-- 排序字段
	sequence_no decimal(8) COMMENT '排序字段',
	-- 关联父主键
	parent_id varchar(32) COMMENT '父主键',
...
(
	...
	description varchar(200) COMMENT '描述',
	-- 角色英文名称
	role_name_en varchar(50) COMMENT '角色英文名称',
	-- 最后修改时间
	update_time datetime COMMENT '最后修改时间',
	-- 最后修改人
	update_user varchar(32) COMMENT '最后修改人',
...
(
	...
	company_role_id varchar(32) COMMENT '公司角色关联表id',
	-- 如果链接中有参数，则设置参数标记。如:businessType=modify
	param_flag varchar(100) COMMENT '参数标记',
	-- 分区字段,从用户公司代码字段取值
	partition_company varchar(8) NOT NULL COMMENT '分区字段',
	PRIMARY KEY (id_)
...
(
	...
	oraginal_role_menu_id varchar(64) COMMENT '继承的角色菜单id',
	-- 角色代码
	role_code varchar(32) NOT NULL COMMENT '角色代码',
	-- 菜单代码
...
(
	...
	id_ varchar(64) NOT NULL COMMENT '记录主键',
	-- 系统代码
	system_code varchar(32) NOT NULL UNIQUE COMMENT '系统代码',
	-- 系统名称
...
(
	...
	id_ varchar(64) NOT NULL COMMENT '记录主键',
	-- 用户代码
	user_id varchar(32) NOT NULL UNIQUE COMMENT '用户代码',
	-- 上上一级公司，也就是这一级的上一级公司
	owner_company_code varchar(64) COMMENT '上一级公司',
	-- 是否有效,Y:是;N:否
	-- 控制是否在公司任职有效
