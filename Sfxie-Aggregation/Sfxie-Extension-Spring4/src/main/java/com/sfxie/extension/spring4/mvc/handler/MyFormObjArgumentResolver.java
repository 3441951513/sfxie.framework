package com.sfxie.extension.spring4.mvc.handler;
...
import com.sfxie.extension.spring4.mvc.annotation.FormObj;
/**
 * 自己定义的spring参数绑定器示例
 * @TODO	
 * @author 	xieshengfeng
 * @email  	xsfcy@126.com
 * @since 	上午9:34:54 2015-8-14
 * @example		
 *
 */
public class MyFormObjArgumentResolver implements HandlerMethodArgumentResolver {
