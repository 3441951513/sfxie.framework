package com.sfxie.extension.spring4.mvc.exception.event.controller;
 ...
 */
public class ControllerLoggerEventHandlerImpl extends LoggerEventHandler{

	
	public ControllerLoggerEventHandlerImpl( MvcException exception) {
		super(exception);
	}
...
//		sb.append(exceptionEntity.getLayer());
		...
		sb.append(dateString);
		sb.append("###############################################################");
		LoggerUtil.controller(ControllerLoggerEventHandlerImpl.class, sb.toString());
	}
}
