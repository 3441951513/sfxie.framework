...
public class PostObjectPolicy {
	...
	public static void getOSS(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException { 
	
	    String endpoint = "oss-cn-shenzhen.aliyuncs.com";
        String accessId = "p7Cs5zrHIoTWsvYW";
        String accessKey = "9qjRWRQhxoIWpBVz5C0iwzLjVa5rYX";
        String bucket = "wycrm";
        String dir = "user-dir";
