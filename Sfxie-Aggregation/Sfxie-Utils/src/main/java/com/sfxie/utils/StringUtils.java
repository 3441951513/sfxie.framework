...
/**
    ...
    public static void main(String[] args) {
    	System.out.println(match("/puglin/*/","/puglin/dd/aa/"));
    	System.out.println(match("*", "toto"));
    	System.out.println(match("t?t?.java", "tutu.java"));
    	System.out.println(match("12345", "1234"));
    	System.out.println(match("1234", "12345"));
	}
}
