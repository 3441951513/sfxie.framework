package com.sfxie.extension.mybatis.multydatasoure.dynamic;
...
import com.sfxie.extension.mybatis.multydatasoure.zookeeper.ZookeeperDatasourceEntity;
...
public class MycatDiscovery {
	...
	public static void initDiscovery(CuratorFramework client,IZookeeperWatchChangeAction action) throws Exception{
		PATH = SwitchPropertyPlaceholderConfigurer.getProperty("multiDatasourcZkPath");
		serviceName = SwitchPropertyPlaceholderConfigurer.getProperty("multiDatasourcZkServiceName");
        try
        {
//            client.start();
